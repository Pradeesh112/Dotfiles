...
## for transparency.
## Type: QssColor
c.colors.hints.bg = solarized['base03']
...
c.url.searchengines = {
        ...
        'd': 'https://www.urbandictionary.com/define.php?term={}&utm_source=search-action',
        'aw': 'https://wiki.archlinux.org/index.php?title=Special%3ASearch&search={}',
        'ap': 'https://archlinux.org/packages/?sort=&q={}',
        'ay': 'https://aur.archlinux.org/packages/?O=0&SeB=nd&K={}',
